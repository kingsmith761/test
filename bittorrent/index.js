...
// webtorrent-cli / node_modules / webtorrent / index.js
...
class WebTorrent extends EventEmitter {
    constructor(opts = {}) {
        super()
        console.log('[WebTorrent init]:',opts)
        ...
        if (typeof TCPPool === 'function') {
            ...
            this._tcpPool.server.iota = opts.iota
        } else {
            process.nextTick(() => {
                this._onListening()
            })
        ...
        if(opts.iota !== undefined) this.iota = opts.iota
